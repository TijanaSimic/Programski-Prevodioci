...
public class SymbolTableDump extends SymbolTableVisitor {
	...
	public void visitScopeNode(Scope scope) {
		//	output.append("(level ").append(scope);
		//RAZMISLITI KAKO DA DODAM LEVEL	
	...
	//	log.info("TIP JE " + structToVisit.getKind());
		...
		//	if(structToVisit.getElemType()!=null)
			//log.info(structToVisit.getElemType().getKind());
